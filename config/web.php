...
$config = [
    ...
    'components' => [
        'request' => [
            ...
            'cookieValidationKey' => '5o5sg3pm4ojUElhUb29NmnMtmrm_c-Gf',
        ],
        'cache' => [
        ...
        'mailer' => [
            ...
            'transport' => [
                ...
                'host' => 'smtp.gmail.com',
                'username' => 'gestinventabilidad@gmail.com',
                'password' => 'GestionInventario',
                'port' => '587',
                'encryption' => 'tls',
                ],
        ],
...
if (YII_ENV_DEV) {
    ...
    $config['modules']['gii'] = [
        ...
        'allowedIPs' => ['127.0.0.1', '192.168.1.110', '192.168.1.*'],
    ];
}
